<template lang="pug">
  div.hello
    // #topic
    // propsで受け取ったものを出力したい場合は{{ propertyName }}で使える
    h1 {{ myMessage }}

    // #topic
    // pugで「文章 <br> 文章続き」と書きたい場合は以下のように書く | がキモ
    p For guide and recipes on how to configure / customize this project, 
      br
      | check out the
...
export default class HelloWorld extends Vue {
  // #topic
  // vueでの :props [myMessage] に相当する
  @Prop() private myMessage!: string;
}
</script>
